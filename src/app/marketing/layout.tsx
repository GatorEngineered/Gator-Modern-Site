...
export const metadata: Metadata = {
    ...
    keywords: [
        ...
        "SEO Brooksville FL",
        "SEO Dade City FL",
        "digital marketing Port Richey FL",
        "digital marketing New Port Richey FL",
        "digital marketing Lutz FL",
    ],
    alternates: { canonical: "https://gatorengineered.com/marketing" },
    openGraph: {
        type: "website",
        url: "https://gatorengineered.com/marketing",
