...
const PROJECTS = [
  {
    ...
    desc: "QR code rewards, USDC payouts, NFT perks, and referral tracking — no app download required. Built and launched solo from concept to paying client.",
    tags: ["Blockchain", "USDC", "QR Rewards", "n8n", "SaaS"],
  ...
  },
  {
    ...
    desc: "Routes applications across 67 counties, pre-fills packets, and generates blockchain-verifiable permit records on Polygon transferable at property resale.",
